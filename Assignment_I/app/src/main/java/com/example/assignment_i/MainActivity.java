...
public class MainActivity extends AppCompatActivity {
    ...
    public void searchURL() {
        String server_url = "https://my-json-server.typicode.com/typicode/demo/posts";
...
//      server_url = redefineURL(server_url);
    ...
    // handling json type response https://my-json-server.typicode.com/typicode/demo/posts
    Response.Listener<String> getResonse = new Response.Listener<String>() {
        @Override
        public void onResponse(String response) {
            Gson gson = new Gson();
            PostDataType[] postResult = gson.fromJson(response, PostDataType[].class);
            textView.setText(postResult[0].id + " " + postResult[0].title + "\n"
                    + postResult[1].id + " " + postResult[1].title + "\n"
                    + postResult[2].id + " " + postResult[2].title);
        }
    };
